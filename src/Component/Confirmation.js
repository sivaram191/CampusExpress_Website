  ...
  return (
    <div className="funds-success-message-container">
      ...
      <div className="funds-success-message">
        <p>"Get ready for a hassle-free pickup experience! Our friendly delivery executive will reach out to you soon to arrange the collection of your luggage"</p>
      </div>
    </div>
  );
};
